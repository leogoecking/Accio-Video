...
LATEST_RELEASE_API_URL: Final = (
    "https://api.github.com/repos/leogoecking/Accio-Video/releases/latest"
)
LATEST_RELEASE_PAGE_URL: Final = (
    "https://github.com/leogoecking/Accio-Video/releases/latest"
)
...
RELEASE_CHECK_HEADERS: Final = {
    ...
    "User-Agent": "Accio-Video-Version-Checker",
}
...
class AsyncUpdateChecker:
    ...
    def _run_check(self, current_version: str) -> None:
        try:
            ...
            logger.exception(
                "unexpected error while checking for a Accio Video update"
            )
