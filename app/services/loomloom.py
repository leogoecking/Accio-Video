"""LoomLoom Market clients for Accio Video batch generation.
...
# Accio Video 集成的内部常量，用户只需提供 API Key，不应接触 Listing ID。
...
class LoomLoomSettings:
    ...
    def from_mapping(
        ...
        settings = cls(
            ...
            # Accio Video 固定调用项目已经上架的默认 SkillBot。Listing ID
