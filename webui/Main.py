...
st.set_page_config(
    page_title="Accio Video",
    page_icon="🪄",
    layout="wide",
    initial_sidebar_state="auto",
    menu_items={
        "Report a bug": "https://github.com/leogoecking/Accio-Video/issues",
        "About": "# Accio Video\nSimply provide a topic or keyword for a video, and it will "
        "automatically generate the video copy, video materials, video subtitles, "
        "and video background music before synthesizing a high-definition short "
        "video.\n\nhttps://github.com/leogoecking/Accio-Video",
    },
)
...
def _render_brand(available_update: str | None = None):
    ...
    st.markdown(
        f"""
        <h1 class="mpt-brand">
            <span class="mpt-brand__name">Accio Video</span>
            <a class="mpt-brand__version"
               href="https://github.com/leogoecking/Accio-Video"
               target="_blank"
               rel="noopener noreferrer"
               aria-label="Open Accio Video on GitHub"
